...
podman run --name srv1c --ip 10.88.0.3 --hostname $HOSTNAME --add-host=pgpro:10.88.0.2 -dt -p 1540-1541:1540-1541 -p 1560-1591:1560-1591 -v /_data:/_data:Z docker.io/kostikpl/rhel8:srv1c-8.3.1_rhel-8.4
